...
#SBATCH --output=slurm-%j-out.txt   # Output log file (job ID replaces %j)
#SBATCH --time=192:00:00            # Maximum run time (HH:MM:SS)
...
#python3 Wafer-map/Wafer-data-dataset-resize-training.py --config Wafer-map/config.yaml
